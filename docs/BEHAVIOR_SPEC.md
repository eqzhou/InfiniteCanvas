...
| 2026-07-25 | Tiger public recheck | Re-read public Tiger CHANGELOG and release metadata without source inspection | Latest tag remains `v0.4.4`; new Unreleased names cover Ctrl/Cmd+G grouping, repeated-pointer drag cleanup, hover toolbar presentation, and long-model-name layout, all already represented by local behavior or layout contracts | high |
...
| 2026-07-25 | Generation history soft delete | Delete a completed workbench history card, list history, then fetch the job by id | The card disappears from history listing while the tombstone remains readable by id with status `deleted`; a second delete is idempotent |
...
| https://api.github.com/repos/tigerowo/infinite-canvas/releases/latest | 2026-07-25 | Public release metadata recheck; latest tag remains `v0.4.4` (published 2026-07-23 China time); SHA-256 `e299e853ebd94600c9756c454ec3a7acd4360fbdf2129b6ea3909e23e839cd36` |
