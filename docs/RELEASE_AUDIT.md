...
- [x] Full CI Playwright suite passes (128 passed, 8 intentional environment skips) across Chromium, WebKit, Firefox, and mobile Chromium in the latest completed run.
