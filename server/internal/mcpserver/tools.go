...
var boardTools = []toolDefinition{
	...
	},
	{
		...
		InputSchema: objectSchema(map[string]any{"projectId": projectIDProperty(), "confirmationToken": map[string]any{"type": "string", "minLength": 64, "maxLength": 64}}, "projectId", "confirmationToken"),
		Annotations: map[string]any{"destructiveHint": true},
	},
	{
		Name:        "film.run_stage",
		Title:       "Run film stage",
		Description: "Run a dependency-checked film stage at its exact optimistic revision. AI text stages require providerId, model, and idempotencyKey; script also requires episodeId. Media generation stages additionally require config.",
		InputSchema: objectSchema(map[string]any{
			"projectId":  projectIDProperty(),
			...
			"episodeId":  projectIDProperty(),
			"scriptMode": map[string]any{"type": "string", "enum": []string{"adaptive", "literal", "shooting"}},
		...
		}, "projectId", "stage", "revision", "confirmationToken"),
	...
	},
	{
		...
		InputSchema: objectSchema(map[string]any{"projectId": projectIDProperty(), "stage": map[string]any{"type": "string"}, "revision": map[string]any{"type": "integer", "minimum": 1}, "confirmationToken": map[string]any{"type": "string", "minLength": 64, "maxLength": 64}}, "projectId", "stage", "revision", "confirmationToken"),
		Annotations: map[string]any{"destructiveHint": true},
	},
	{
	...
	},
	{
		...
		InputSchema: objectSchema(map[string]any{"projectId": projectIDProperty(), "kind": map[string]any{"type": "string", "enum": []string{"mp4", "srt", "manifest", "asset_bundle"}}, "revision": map[string]any{"type": "integer", "minimum": 1}, "idempotencyKey": map[string]any{"type": "string", "minLength": 1, "maxLength": 128}, "confirmationToken": map[string]any{"type": "string", "minLength": 64, "maxLength": 64}}, "projectId", "kind", "revision", "idempotencyKey", "confirmationToken"),
		Annotations: map[string]any{"destructiveHint": true, "openWorldHint": true},
	},
}
